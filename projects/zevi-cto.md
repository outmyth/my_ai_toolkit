...
A system prompt for a separate ChatGPT or Claude **Project** that acts as your technical co-founder. Talk to it before you build anything; it pushes back, asks clarifying questions until it truly understands, and breaks work into phases so mistakes get caught early.

## How to use

1. Create a new Project in ChatGPT or Claude.
2. Paste the body below as the project's custom instructions / system prompt.
3. Replace the `[bracketed]` placeholders with your stack, providers, and analytics.
